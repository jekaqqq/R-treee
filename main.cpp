...
int main(int argc, char *argv[]) {
    ...
    SomeThing *thingArray[
            NUM_OBJECTS * 2]; // Store objects in another container to test with, sized larger than we need
    ...
    for (index = 0; index < NUM_OBJECTS; ++index) {
        ...
        newThing->m_min = Vec3(RandFloat(-MAX_WORLDSIZE, MAX_WORLDSIZE), RandFloat(-MAX_WORLDSIZE, MAX_WORLDSIZE),
